		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txtNombre.getText() != null && txtApellido.getText() != null && txtFechaN.getDate() != null
					&& txtNacionalidad.getSelectedItem().toString() != null && txtTelefono.getText() != null &&
...
//				principal.setVisible(true);
	...
	private void guardar() {
		...
		try {
			valor = Integer.parseInt(txtTelefono.getText());
		...
		long nacimiento = txtFechaN.getDate().getTime();
